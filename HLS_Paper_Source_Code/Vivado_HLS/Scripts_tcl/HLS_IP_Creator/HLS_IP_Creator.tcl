...
puts "Name of HLS project: "
gets stdin prj_name
puts $fp "open_project -reset $prj_name"

puts "Name of top-level function: "
gets stdin topfunc
puts $fp "set_top $topfunc"
set top_level $topfunc
set top_level2 "$topfunc\_0"

puts "Insert C/C++ specification file name (include extension .c/.cpp): "
gets stdin spc_file
...
while {$option==Y || $option==y} {
    puts "Insert C/C++ specification file: "
    gets stdin spc_file
    puts $fp "add_files $spc_file"
    puts "Do you want to insert another C/C++ specification file: (Y/N) "
    gets stdin option
...
puts "Insert C/C++ test bench file name (include extension .c/.cpp): "
gets stdin spc_file
...
while {$option==Y || $option==y} {
    puts "Insert C/C++ test bench file: "
    gets stdin spc_file
    puts $fp "add_files -tb $spc_file"
    puts "Do you want to insert another C/C++ test bench file: (Y/N) "
    gets stdin option
