...
if {$option==2} {
    ...
    puts $fp "set_top fft"
    puts $fp "add_files fft.cpp"
    puts $fp "add_files fft.h"
    puts $fp "add_files -tb fft_test.cpp"
    puts $fp "add_files -tb out.gold.dat"
...
if {$option==3} {
    ...
    puts $fp "add_files aes.cpp"
    puts $fp "add_files aes.h"
    puts $fp "add_files aes_dec.cpp"
    puts $fp "add_files aes_enc.cpp"
    puts $fp "add_files aes_func.cpp"
    puts $fp "add_files aes_key.cpp"
    puts $fp "add_files -tb aes_test.cpp"
...
if {$option==4} {
    ...
    puts $fp "add_files backprop.h"
    puts $fp "add_files backprop.cpp"
    puts $fp "add_files -tb out_gold.dat"
    puts $fp "add_files -tb backprop_test.cpp"
...
if {$option==5} {
    ...
    puts $fp "set_top ANN"
    puts $fp "add_files ANN.cpp"
    puts $fp "add_files ANN.h"
    puts $fp "add_files -tb ANN_test.cpp"
